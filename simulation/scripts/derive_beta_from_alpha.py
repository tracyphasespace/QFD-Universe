...
def main():
    ...
    print(f"{'Current GoldenLoop.lean':<40} {'3.043233':>12} {'0.328598':>12}")
    print()
    ...
    print(f"To get β = {beta_target:.4f} from LEVEL4 formula:")
    ...
    print("e^β/β = (α⁻¹ × c₁) / π²")
    print()
    print(f"The deprecated β = 3.058 (fitted) differs by ~0.5%")
    print("We now use the derived value.")
    print()
